...
const patientFieldsName = ['name', 'surname', 'dt_birth', 'fiscal_code', 'phone']
...
function getDeleteOperation() {
    switch(type){
        ...
        case 'prescription': return deletePrescription;
    }
}
...
function getUpdateOperation() {
    switch(type){
        ...
        case 'prescription': return updatePrescription;
    }
}
...
function getInsertOperation() {
    switch(type){
        ...
        case 'prescription': return addPrescription;
    }
}
...
function getCardData() {
    switch(type){
        ...
        case 'prescription': return getAllPrescriptions;
    }
}
...
function modalAction() {
    ...
    if(type === 'prescription'){
        ...
        for (const checkbox of document.getElementsByClassName('prescription-medicine-checkbox')){
            ...
            if(checkbox.checked){
                medicinesList.push(allMedicines.filter((medicine) => medicine.id === checkbox.id)[0])
            }
        }
